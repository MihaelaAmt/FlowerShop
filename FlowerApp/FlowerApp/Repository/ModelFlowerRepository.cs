    ...
    public class ModelFlowerRepository : IFlowerRepository
    {
        ...
        public IEnumerable<Flower> Flowers
        {
            get
            {
                ...
                {
                    new Flower {FlowerId = 1, Name="Lilies", Price=15.95M, ShortDescription="White lilies", LongDescription="dfdfd", Category = _categoryRepository.Categories.ToList()[0],
                    ...
                    new Flower {FlowerId = 2, Name="Peonies", Price=18.95M, ShortDescription="Pink peonies", LongDescription=" hghgjx", Category = _categoryRepository.Categories.ToList()[1],
                        ImageUrl ="https://purpleflowers.ro/wp-content/uploads/2018/06/BUC52-Buchet-diafan-cu-25-bujori-roz.jpg", InStock=true,
                        ImageThumbnailUrl ="https://purpleflowers.ro/wp-content/uploads/2018/06/BUC52-Buchet-diafan-cu-25-bujori-roz.jpg"},

                    new Flower {FlowerId = 3, Name="Roses", Price=15.95M, ShortDescription="Red roses", LongDescription=" khhfgdsg", Category = _categoryRepository.Categories.ToList()[0],
                    ...
                    new Flower {FlowerId = 4, Name="Tulips", Price=12.95M, ShortDescription="Yellow tulips", LongDescription="sfsdga", Category = _categoryRepository.Categories.ToList()[2],
